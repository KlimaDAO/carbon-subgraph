...
export class BaseCarbonTonne extends ethereum.SmartContract {
  static bind(address: Address): BaseCarbonTonne {
    return new BaseCarbonTonne("BaseCarbonTonne", address);
  }
