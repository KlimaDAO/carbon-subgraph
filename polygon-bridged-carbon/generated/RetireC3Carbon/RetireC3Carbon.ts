...
export class TridentChanged extends ethereum.Event {
  get params(): TridentChanged__Params {
    return new TridentChanged__Params(this);
  }
}

export class TridentChanged__Params {
  _event: TridentChanged;

  constructor(event: TridentChanged) {
    this._event = event;
  }

  get oldBento(): Address {
    return this._event.parameters[0].value.toAddress();
  }

  get newBento(): Address {
    return this._event.parameters[1].value.toAddress();
  }

  get oldTrident(): Address {
    return this._event.parameters[2].value.toAddress();
  }

  get newTrident(): Address {
    return this._event.parameters[3].value.toAddress();
  }
}

export class RetireC3Carbon__getNeededBuyAmountResult {
  value0: BigInt;
  value1: BigInt;
...
export class RetireC3Carbon extends ethereum.SmartContract {
  static bind(address: Address): RetireC3Carbon {
    return new RetireC3Carbon("RetireC3Carbon", address);
  }
  ...
  addPool(
    ...
    let result = super.call(
      "addPool",
      "addPool(address,address,address):(bool)",
      [
        ethereum.Value.fromAddress(_poolToken),
        ethereum.Value.fromAddress(_router),
        ethereum.Value.fromAddress(_tridentPool)
      ]
    );
  ...
  getNeededBuyAmount(
  ...
  ): RetireC3Carbon__getNeededBuyAmountResult {
    let result = super.call(
      "getNeededBuyAmount",
    ...
    return new RetireC3Carbon__getNeededBuyAmountResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getNeededBuyAmount(
    ...
    _poolAmount: BigInt,
    _specificRetire: boolean
  ): ethereum.CallResult<RetireC3Carbon__getNeededBuyAmountResult> {
    let result = super.tryCall(
      "getNeededBuyAmount",
      "getNeededBuyAmount(address,address,uint256,bool):(uint256,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new RetireC3Carbon__getNeededBuyAmountResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  tridentPool(param0: Address): Address {
    let result = super.call("tridentPool", "tridentPool(address):(address)", [
      ethereum.Value.fromAddress(param0)
    ]);
  ...
  try_tridentPool(param0: Address): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "tridentPool",
      "tridentPool(address):(address)",
      [ethereum.Value.fromAddress(param0)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  tridentRouter(): Address {
    let result = super.call("tridentRouter", "tridentRouter():(address)", []);

    return result[0].toAddress();
  }

  try_tridentRouter(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "tridentRouter",
      "tridentRouter():(address)",
      []
...
export class RetireC3Call extends ethereum.Call {
  get inputs(): RetireC3Call__Inputs {
    return new RetireC3Call__Inputs(this);
  }

  get outputs(): RetireC3Call__Outputs {
    return new RetireC3Call__Outputs(this);
  }
}

export class RetireC3Call__Inputs {
  _call: RetireC3Call;

  constructor(call: RetireC3Call) {
    this._call = call;
  }
...
export class RetireC3Call__Outputs {
  _call: RetireC3Call;
...
export class RetireC3SpecificCall extends ethereum.Call {
  get inputs(): RetireC3SpecificCall__Inputs {
    return new RetireC3SpecificCall__Inputs(this);
  }

  get outputs(): RetireC3SpecificCall__Outputs {
    return new RetireC3SpecificCall__Outputs(this);
  }
}

export class RetireC3SpecificCall__Inputs {
  _call: RetireC3SpecificCall;

  constructor(call: RetireC3SpecificCall) {
    this._call = call;
  }
...
export class RetireC3SpecificCall__Outputs {
  _call: RetireC3SpecificCall;
...
export class SetTridentCall extends ethereum.Call {
  get inputs(): SetTridentCall__Inputs {
    return new SetTridentCall__Inputs(this);
  }

  get outputs(): SetTridentCall__Outputs {
    return new SetTridentCall__Outputs(this);
  }
}

export class SetTridentCall__Inputs {
  _call: SetTridentCall;

  constructor(call: SetTridentCall) {
    this._call = call;
  }

  get _tridentRouter(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
...
export class SetTridentCall__Outputs {
  _call: SetTridentCall;
